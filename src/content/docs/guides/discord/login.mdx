...
3. Vérifie les informations demandées
...
🎉 Félicitations, tu es maintenant inscrit et connecté avec Discord ! Tu n'as plus besoin de retenir un mot de passe supplémentaire et tu peux profiter de la reconnexion automatique.
...
6. Saisis ton mot de passe Extinction pour valider la liaison
